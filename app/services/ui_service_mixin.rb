  ...
  def icons
    {
      ...
      :PhysicalChassis         => {:type => "glyph", :class => PhysicalChassis.decorate.fonticon},
      :PhysicalRack            => {:type => "glyph", :class => PhysicalRack.decorate.fonticon},
      :PhysicalServer          => {:type => "glyph", :class => PhysicalServer.decorate.fonticon},
      :PhysicalSwitch          => {:type => "glyph", :class => PhysicalSwitch.decorate.fonticon},
      :PhysicalStorage         => {:type => "glyph", :class => PhysicalStorage.decorate.fonticon},

    ...
    select(
      ...
      :items => [
        ...
        button(
          :vm_guest_lock,
          nil,
          N_('Lock the Guest OS on this VM'),
          N_('Lock Guest'),
          :icon    => "pficon pficon-locked fa-lg",
          :confirm => N_("Lock the Guest OS on this VM?"),
          :klass   => ApplicationHelper::Button::GenericFeatureButtonWithDisable,
          :options => {:feature => :lock_guest}),
        button(
          :vm_guest_unlock,
          nil,
          N_('Unlock the Guest OS on this VM'),
          N_('Unlock Guest'),
          :icon    => "pficon pficon-unlocked fa-lg",
          :confirm => N_("Unlock the Guest OS on this VM?"),
          :klass   => ApplicationHelper::Button::GenericFeatureButtonWithDisable,
